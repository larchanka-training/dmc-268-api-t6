...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda value: value["findings"][0].update(start_line=12),
        ...
        lambda value: value["findings"][0].update(rule_name="Required Rule"),
        lambda value: value["findings"][0].update(
            body="According to custom instructions in 'Required Rule' (details): bad",
        ),
